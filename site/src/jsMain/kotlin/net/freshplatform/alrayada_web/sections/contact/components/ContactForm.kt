...
import net.freshplatform.alrayada_web.components.core.MyButton
import net.freshplatform.alrayada_web.components.core.MyButtonWithText
import net.freshplatform.alrayada_web.components.fa.FaWhatsapp
...
import net.freshplatform.alrayada_web.utils.getInputValueById
...
fun ContactForm() = Form(
    action = SectionsConstants.Contact.FORM_URL,
    attrs = Modifier
        .attrsModifier {
            attr("method", "POST")
        }
...
//                        FormData().get(nameInputId) // This approach require refactor the whole form with new way to handle it
                        ...
                        val url = SectionsConstants.Contact.whatsappUrlWithText(text)
